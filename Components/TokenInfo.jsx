        ...
        <div className="row">
          <div className="col-xl-8 offset-xl-4 ">
            <div className="token-info__title sec-title mb-95 text-center text-xl-start">
              <h5 className="sec-title__subtitle">ICO WOOFI TOKEN</h5>
              <h2 className="sec-title__title">Deatils about <br /> WOOFI token</h2>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-8">
            <div className="token-info--info-wrap ul_li">
              <ul className="token-info__list token-info__start">
                <li>
                  <h4>Total Supply</h4>
                  <span>
                ...
                <li>
                  <h4>Minimum Transation</h4>
                  <span>
                    10 Tokens / Transation
                  </span>
                </li>
              </ul>
              <ul className="token-info__list token_infi--end">
                <li>
                  <h4>Token Market Valuation</h4>
                  <span>
